...
#define PLANT colour(40,40,40,255)
#define ROOT colour(20,20,20,255)

form size(380, 284), caption("Double Down"), pluginID("dbl2"), $ROOT

groupbox bounds(10, 10, 360, 80), text("In / Out"), line(1) plant("io"), $PLANT {
...
groupbox bounds(10, 94, 360, 180), text("Doubler"), line(1) plant("doubler"), $PLANT {
...
; smooth delay time
kdelay port kdelay, $PORT_TIME*5
